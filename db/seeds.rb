...
Charity.create(name:"Sylvia Rivera Law Project",
   ...
   picture: "https://i.imgur.com/nIbUHKm.jpg",
   icon: "https://i.imgur.com/1XjYAEG.png",
...
Charity.create(name:"Food Not Bombs",
   ...
   picture: "https://i.imgur.com/mIXe1u5.png",
   icon: "https://i.imgur.com/ZncQ0Xx.png",
...
Charity.create(name:"Make the Road New York",
   ...
   category: "Human and Civil Rights",
   cause: "Advocacy and Education",
   picture: "https://i.imgur.com/0eCEbMT.jpg",
   icon: "https://i.imgur.com/0gjNGDP.jpg",
...
User.create(first_name: "Dick",
   ...
   Support.create(user_id: 1, charity_id: 4, donation: 4)
